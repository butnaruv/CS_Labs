...
public class MessageManipulator {
    ...
    private static List<Integer> P = Arrays.asList (16, 7, 20, 21, 29, 12, 28, 17, 1,  15, 23,
            26, 5, 18, 31, 10, 2,  8,  24, 14, 32, 27,
            3,  9, 19, 13, 30, 6,  22, 11, 4,  25 );

    public static ArrayList<Integer> Round(ArrayList<Integer> binaryMessage, ArrayList<Integer> subKey) {
...
//        System.out.println("Subkey: " + subKey);
        ArrayList<Integer> resultOfFFunction = FFunction(right, subKey);
        ArrayList<Integer> newRight = new ArrayList<>();
        for (int i = 0; i < left.size(); i++) {
            newRight.add(Xor(left.get(i), resultOfFFunction.get(i)));
        }
        ArrayList<Integer> newLeftandRight =  newLeft;
    ...
    private static ArrayList<Integer> FFunction(ArrayList<Integer> right, ArrayList<Integer> subKey) {
        ...
        //System.out.println("Permuted right part of 48 bits" + right);
